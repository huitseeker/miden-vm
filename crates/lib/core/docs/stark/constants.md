...
| air_trace_length_logs_ptr | Returns the base pointer of the per-AIR log-height cells.<br /><br />One cell per AIR, consecutive, in canonical instance order:<br />[core, chiplets, poseidon2_permutation].<br /> |
