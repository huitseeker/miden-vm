use miden_core::{BasedVectorSpace, Felt, Field, PrimeCharacteristicRing, QuadFelt};
...
proptest! {
    ...
    fn test_op_fri_ext2fold4(
        ...
        // Query values
        let query_values = [
            QuadFelt::from([Felt::new(v0_0), Felt::new(v0_1)]),
            QuadFelt::from([Felt::new(v1_0), Felt::new(v1_1)]),
            QuadFelt::from([Felt::new(v2_0), Felt::new(v2_1)]),
            QuadFelt::from([Felt::new(v3_0), Felt::new(v3_1)]),
        ];
