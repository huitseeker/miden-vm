...
| exp.*uxx* <br /> - *(9 + xx cycles)*  <br /> exp.*b* <br /> - *(see notes)* | [b, a, ...] | [c, ...]      | $c \leftarrow a^b$ <br /> Fails if xx is outside [0, 63] <br /> exp is equivalent to exp.u64 and needs 73 cycles <br /> `exp.`*b* needs 3, 1, 2, 4, 6, 8, 10, 12 cycles for $b = 0, 1, \ldots, 7$, and $11 + \lfloor log_2(b) \rfloor$ cycles for $b > 7$ |
| ilog2 <br /> - *(70 cycles)*                                                      | [a, ...]    | [b, ...]      | $b \leftarrow \lfloor{log_2{a}}\rfloor$ <br /> Fails if $a = 0 $                                                                    |
...
| lt <br /> - *(17 cycles)* <br /> lt.*b* <br /> - *(18 cycles)*   | [b, a, ...] | [c, ...]       | $c \leftarrow \begin{cases} 1, & \text{if}\ a < b  0, & \text{otherwise}\ \end{cases}$                                     |
...
| ext2inv <br /> - *(11 cycles)*  <br /> | [a0, a1, ...]         | [a0', a1', ...] | $a' \leftarrow a^{-1}$ in $\mathbb{F}_p[x]/(x^2 - 7)$ <br /> Fails if $a = 0$                   |
| ext2div <br /> - *(14 cycles)*  <br /> | [b0, b1, a0, a1, ...] | [c0, c1,]       | $c \leftarrow a \cdot b^{-1}$ in $\mathbb{F}_p[x]/(x^2 - 7)$ <br /> Fails if $b=0$              |
